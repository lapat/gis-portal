...
COUNTY_CONFIGS = {
    ...
    "Madison County": {
        "url": "https://gisportal.co.madison.il.us/servera/rest/services/CCAO/Parcel_Owners/MapServer/0/query",
        "query_field": "CO_PIN",
        "display_field": "PIN",
        "extra_out_fields": ["PIN"],
        "clean": lambda p: re.sub(r'[^0-9]', '', p),
        "query_style": "exact",
        "sample": "07-1-11-02-00-000-002",
        "hint": "7-segment format ##-#-##-##-##-###-### or 15-digit CO_PIN. Dashes are ignored.",
        "timeout": 15,
    },
    "McLean County": {
        "url": "https://gis.mcleancountyil.gov/arcgis/rest/services/BnZ/Parcels/MapServer/0/query",
        "query_field": "PIN",
        "display_field": "PIN",
        "extra_out_fields": [],
        "clean": _strip,
    ...
    "Peoria County": {
        "url": "https://services.arcgis.com/iPiPjILCMYxPZWTc/arcgis/rest/services/Tax_Parcels/FeatureServer/5/query",
        "query_field": "PIN",
        "display_field": "PIN",
        "extra_out_fields": [],
        "clean": _strip,
